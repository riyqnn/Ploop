...
var _Transaction = class _Transaction2 {
  ...
  setExpiration(expiration) {
    __privateGet6(this, _data).expiration = expiration ? parse(TransactionExpiration2, expiration) : null;
  }
  setGasPrice(price) {
...
var JSONRpcTransport = class extends Experimental_CoreClient {
  ...
  resolveNameServiceNames(options) {
    return __privateGet7(this, _jsonRpcClient).resolveNameServiceNames(options);
  }
  resolveTransactionPlugin() {
    return suiClientResolveTransactionPlugin(__privateGet7(this, _jsonRpcClient));
  }
};
...
*/
//# sourceMappingURL=chunk-ERPDP4WA.js.map
